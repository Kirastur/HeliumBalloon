...
public class BlocksDefinition implements ElementDefinition {

	public static final String ELEMENT_TYPE = "blocks";
	...
	public ConfigElement createConfigElement(ConfigurationSection fileSection) throws BalloonException {
		return new BlocksCompoundConfig(this, fileSection);
	}
}
